      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-border/50 shadow-xl backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>Start your academic journey today — it's free</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {/* Registration form */}
            <form id="register-form" action={action} noValidate className="space-y-4">
              {/* Name */}
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  aria-describedby={state?.errors?.name ? 'register-name-error' : undefined}
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  aria-describedby={state?.errors?.email ? 'register-email-error' : undefined}
              ...
              <div className="space-y-1.5">
                ...
                {state?.errors?.password ? (
                  <div id="register-password-requirements" role="alert">
                  ...
                  <div id="register-password-requirements">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="••••••••"
                    aria-describedby={
                      state?.errors?.confirmPassword ? 'register-confirm-error' : undefined
                    }
